...
/**
 *  \file       funding_document.php
 *  \ingroup    funding
 *  \brief      Tab for documents linked to Funding
 */
...
$hookmanager->initHooks(array('fundingdocument', 'globalcard')); // Note that conf->hooks_modules contains array
...
//if ($id > 0 || ! empty($ref)) $upload_dir = $conf->funding->multidir_output[$object->entity?$object->entity:$conf->entity] . "/funding/" . dol_sanitizeFileName($object->id);
