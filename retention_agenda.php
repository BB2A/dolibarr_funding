...
/**
 *  \file       retention_agenda.php
 *  \ingroup    funding
 *  \brief      Tab of events on Retention
 */
...
$hookmanager->initHooks(array('retentionagenda', 'globalcard')); // Note that conf->hooks_modules contains array
