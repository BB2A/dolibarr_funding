...
/**
 *  \file       core/modules/funding/doc/pdf_standard.modules.php
 *  \ingroup    funding
...
/**
 *	Class to manage PDF template standard_coefficient
 */
class pdf_standard_coefficient extends ModelePDFCoefficient
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_COEFFICIENT_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->funding->dir_output.'/coefficient')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->funding->dir_output.'/coefficient';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->funding->dir_output.'/coefficient/'.$objectref;
