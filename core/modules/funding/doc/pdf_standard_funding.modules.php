...
/**
 *	Class to manage PDF template standard_funding
 */
class pdf_standard_funding extends ModelePDFFunding
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_FUNDING_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->funding->dir_output.'/funding')
	    {
