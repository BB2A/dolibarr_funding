...
/**
 *	\file       htdocs/core/modules/funding/doc/doc_generic_funding_odt.modules.php
 *	\ingroup    funding
 *	\brief      File of class to build ODT documents for fundings
 */
 ...
 */
class doc_generic_funding_odt extends ModelePDFFunding
{
	/**
	 * Issuer
	 * @var Societe
	...
	public function __construct($db)
	{
		...
		$this->scandir = 'FUNDING_FUNDING_ADDON_PDF_ODT_PATH'; // Name of constant that is used to save list of directories to scan
	...
	public function info($langs)
	{
		...
		$texte .= '<input type="hidden" name="param1" value="FUNDING_FUNDING_ADDON_PDF_ODT_PATH">';
