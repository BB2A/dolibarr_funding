...
/**
 *  \file       coefficient_note.php
 *  \ingroup    funding
 *  \brief      Car with notes on Coefficient
 */
...
$hookmanager->initHooks(array('coefficientnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Coefficient'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("Coefficient"), -1, $object->picto);
