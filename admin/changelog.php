...
/**
 * \file    funding/admin/about.php
 * \ingroup funding
 * \brief   About page of module Funding.
 */
...
// Translations
$langs->loadLangs(array("errors", "admin", "funding@funding"));
...
dol_fiche_head($head, 'changelog', '', 0, 'funding@funding');
