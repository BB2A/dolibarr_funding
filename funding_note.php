...
/**
 *  \file       funding_note.php
 *  \ingroup    funding
 *  \brief      Car with notes on Funding
 */
...
$hookmanager->initHooks(array('fundingnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Funding'), $help_url);
