...
/**
 *  \file       coefficient_agenda.php
 *  \ingroup    funding
 *  \brief      Page of Coefficient events
 */
...
$hookmanager->initHooks(array('coefficientagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("Coefficient"), -1, 'object_'.$object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read)))
	{
		...
		//print load_fiche_titre($langs->trans("ActionsOnCoefficient"), '', '');
