...
/**
 * \file    test/phpunit/FundingFunctionalTest.php
 * \ingroup funding
 ...
 * @package Testfunding
 */
class FundingFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/funding/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('funding/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/funding/admin/about.php');
		$this->authenticate();
		return $this->assertContains('funding/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('fundingwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFunding_FundingTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFunding_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
