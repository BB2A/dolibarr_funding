...
INSERT INTO `llx_c_action_trigger` (`rowid`, `elementtype`, `code`, `label`, `description`, `rang`) VALUES (NULL, 'funding', 'FUNDING_SENTBYMAIL', 'Funding send by mal', 'A funding is send by mail', '1830047');
INSERT INTO `llx_c_action_trigger` (`rowid`, `elementtype`, `code`, `label`, `description`, `rang`) VALUES (NULL, 'funding', 'FUNDING_RUNNING', 'Funding running', 'A funding is running', '1830048');
INSERT INTO `llx_c_action_trigger` (`rowid`, `elementtype`, `code`, `label`, `description`, `rang`) VALUES (NULL, 'funding', 'FUNDING_END', 'Funding end', 'A funding is end', '1830049');
INSERT INTO `llx_c_action_trigger` (`rowid`, `elementtype`, `code`, `label`, `description`, `rang`) VALUES (NULL, 'funding', 'FUNDING_CANCEL', 'Funding cancel', 'A funding is cancel', '1830050');
