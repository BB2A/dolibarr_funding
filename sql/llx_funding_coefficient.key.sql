...
ALTER TABLE llx_funding_coefficient ADD INDEX idx_funding_coefficient_fk_soc (fk_soc);
ALTER TABLE llx_funding_coefficient ADD INDEX idx_funding_coefficient_fk_project (fk_project);
