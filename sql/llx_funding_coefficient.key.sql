...
ALTER TABLE llx_funding_coefficient ADD CONSTRAINT llx_funding_coefficient_fk_scale FOREIGN KEY (fk_scale) REFERENCES llx_c_funding_scale(rowid);
ALTER TABLE llx_funding_coefficient ADD INDEX idx_funding_coefficient_fk_org (fk_org);
ALTER TABLE llx_funding_coefficient ADD CONSTRAINT llx_funding_coefficient_fk_org FOREIGN KEY (fk_org) REFERENCES llx_societe(rowid);
