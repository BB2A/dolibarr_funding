...
ALTER TABLE llx_funding_funding ADD CONSTRAINT llx_funding_funding_fk_scale FOREIGN KEY (fk_scale) REFERENCES llx_c_funding_scale(code);
...
ALTER TABLE llx_funding_funding ADD CONSTRAINT llx_funding_funding_fk_funding_type FOREIGN KEY (fk_funding_type) REFERENCES llx_c_type(code);
